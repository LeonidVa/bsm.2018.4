...
const config = [
    {
        client: {
            avatar: require('static/images/reviews/otziv3m.jpg'),
            name: "Карина",
            text: "Поговорила с вашим преподавателем. И да, помогло. Зря, конечно, не сразу вас послушала. Моя магистерская очень трудная.",
            prof: "студент",
        },
        manager: {
    ...
    {
        client: {
            avatar: require('static/images/reviews/otziv4m.jpg'),
            name: "Николай",
            text: "А вы мне как гарантируете, что я защищусь?",
            prof: "студент",
        },
        manager: {
            avatar: require('static/images/reviews/lis.png'),
    ...
    {
        client: {
            avatar: require('static/images/reviews/otziv5m.jpg'),
            name: "Юлия",
            text: "Все пишут вам отзывы про свои работы, а я хочу сказать, что у вас и офис отличный. Приятно приходить.",
            prof: "студент",
        },
        manager: {
            avatar: require('static/images/reviews/lis.png'),
    ...
    {
        client: {
            avatar: require('static/images/reviews/otziv6m.jpg'),
            name: "Кристина",
            text: "Хорошо, что у вас заказали помочь нам с поурочными разработками. Жаль, что раньше не догадались, теперь знаем. Отличная работа!",
            prof: "студент",
        },
        manager: {
            avatar: require('static/images/reviews/lis.png'),
    ...
    {
        client: {
            avatar: require('static/images/reviews/otziv7.jpg'),
            name: "Елена",
            text: "Мне у вас нравится как делаете, и офис, и менеджеры, и все такое, но у других есть и подешевле. Почему не можете сделать мне диплом за пять тысяч?",
            prof: "студент",
        },
        manager: {
            avatar: require('static/images/reviews/lis.png'),
    ...
    {
        client: {
            avatar: require('static/images/reviews/otziv9.jpg'),
            name: "Анастасия",
            text: "Хорошо прошел курсовой. Думала, не нужно мне краткое содержание, но правда с ним удобно.",
            prof: "студент",
        },
        manager: {
            avatar: require('static/images/reviews/lis.png'),
    ...
    {
        client: {
            avatar: require('static/images/reviews/otzivm.jpg'),
            name: "Антон",
            text: "Курсовой хороший, спасибо. А как вы мне гарантируете диплом?",
            prof: "студент",
        },
        manager: {
            avatar: require('static/images/reviews/lis.png'),
    ...
    {
        client: {
            avatar: require('static/images/reviews/otziv1m.jpg'),
    ...
    {
        client: {
            avatar: require('static/images/reviews/otziv2.jpg'),
            name: "Анна",
            text: "Спасибо за помощь по экзамену от меня и от всей группы.",
            prof: "студент",
        },
        manager: {
            avatar: require('static/images/reviews/lis.png'),
