    ...
    <Wrapper title="О компании BeSmarter!" description="Информация о компании BeSmarter! Тел. +7 (495) 772-40-90.">
        <div className="wrapper bg bg-c2 bg-img bg-img2">
            ...
            <section className="block-text">
                ...
                <ul>
                    <li>
                        <b>Грамотные авторы.</b> Мы доверяем написание работы только людям, имеющим соответствующее вашей теме образование. У нас вы не найдете плагиата с просторов интернета, неумело слепленного в один файл. Более того, наши сотрудники – практикующие преподаватели, которые точно знают, как писать научную работу. Вам не придется удалять лишние пробелы, расставлять точки или редактировать текст.
                    </li>
                    <li>
