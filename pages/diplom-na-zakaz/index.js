...
const page = () => (
    <Wrapper title="Заказать дипломную работу – дипломная работа (диплом) на заказ в Москве, в компании «BeSmarter!». Тел. +7 (495) 772-40-90.">
        <div className="wrapper bg bg-c2 bg-img bg-img3">
            ...
            <MetaTags>
                {/* <title></title> */}
                <meta name="description" content="Хотите заказать дипломную работу в Москве?  В компании «BeSmarter!» работают опытные профессионалы, готовые написать вашу дипломную работу на заказ срочно от 1-го дня, по выгодной цене! Тел. +7 (495) 772-40-90."/>
