...
const page = () => (
    <Wrapper title="Заказать дипломную работу по менеджменту в Москве, в компании «BeSmarter!». Тел. +7 (495) 772-40-90.">
        <div className="wrapper bg bg-c2 bg-img bg-img3">
            ...
            <MetaTags>
                {/* <title></title> */}
                <meta name="description" content="В компании «BeSmarter!» можно срочно и недорого заказать дипломную работу по менеджменту по выгодной цене в Москве. Тел. +7 (495) 772-40-90." />
