    ...
    <Wrapper title="Заказать дипломную работу по педагогике в Москве, в компании «BeSmarter!». Тел. +7 (495) 772-40-90.">
        <div className="wrapper bg bg-c2 bg-img bg-img3">
            ...
            <section className="block-text">
                ...
                <p className="block-text__par">
                    звоните нам +7 495 772 40 90, воспользуйтесь удобной формой заказа или сразу приезжайте в наш <Link href="/contacts"><a>офис</a></Link>, который находится на Арбате!
                </p>
            </section>
