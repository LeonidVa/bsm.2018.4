...
const page = () => (
    <Wrapper title="Заказать диссертацию по медицине – сколько стоит написать диссертацию по медицине в Москве, в компании «BeSmarter!». Тел. +7 (495) 772-40-90.">
        <div className="wrapper bg bg-c2 bg-img bg-img2">
            ...
            <MetaTags>
                {/* <title></title> */}
                <meta name="description" content="Заказать диссертацию по медицине. В компании BeSmarter! Вы сможете заказать помощь в написании диссертации по медицине от надежных и проверенных кандидатов и докторов наук, недорогие цены только в компании «BeSmarter!». Тел. +7 (495) 772-40-90." />
