        ...
        <div className="wrapper bg bg-c2 bg-img bg-img2">
            ...
            <Accordion
                ...
                rows={[
                    ...
                    ["", "Стоимость"],
                    ["", "от, рублей"],
                    [<Link href="/diplom-na-zakaz"><a className="none">Дипломная работа</a></Link>, ""],
            ...
            <Accordion
                ...
                rows={[
                    ...
                    ["", "Стоимость"],
                    ["", "от, рублей"],
                    [<Link href="/dissertaciya-na-zakaz/magisterskaya"><a className="none">Магистерская диссертация</a></Link>, ""],
                    ...
                    [<Link href="/dissertaciya-na-zakaz/magisterskaya/ekonomika"><a className="none">Экономика</a></Link>, "23 000"],
                    [<Link href="/dissertaciya-na-zakaz/magisterskaya/menedzhment"><a className="none">Менеджмент</a></Link>, "22 000"],
                    [<Link href="/dissertaciya-na-zakaz/magisterskaya/psihologiya"><a className="none">Психология</a></Link>, "21 000"],
                    [<Link href="/dissertaciya-na-zakaz/magisterskaya/yurisprudenciya-pravo"><a className="none">Юриспруденция</a></Link>, "21 000"],
                    ["",""],
                    [<span className="strint">Вот что вам нужно для уверенной защиты:</span>],
                    ["", "Стоимость"],
                    ["", "от, рублей"],
            ...
            <Accordion
                ...
                rows={[
                    ...
                    ["", "Стоимость"],
                    ["", "от, рублей"],
                    [<Link href="/diplom-mba-na-zakaz"><a className="none">Дипломнпя работа МВА</a></Link>, "25 000"],
                    ["Кейс МВА", "5 000"],
                    ["Эссе МВА", "3 500"],
                    ["",""],
                    [<span className="strint">Вот что вам нужно для уверенной защиты:</span>],
            ...
            <Accordion
                ...
                rows={[
                    ...
                    ["", "Стоимость"],
                    ["", "от, рублей"],
                    [<Link href="/kursovaya-rabota-na-zakaz"><a className="none">Курсовая работа</a></Link>, ""],
                    ["Теоретическая", "2 500"],
                    ["С практикой", "3 500"],
                    [<Link href="/kursovaya-rabota-na-zakaz/arhitektura"><a className="none">По архитектуре</a></Link>, "6 000"],
                    [<Link href="/kursovaya-rabota-na-zakaz/buhgalterskiy-uchet"><a className="none">По бухгалтерскому учету</a></Link>, "3 500"],
                    [<Link href="/kursovoj-proekt-na-zakaz/po-detalyam-mashin"><a className="none">По деталям машин</a></Link>, "7 000"],
                    [<Link href="/kursovaya-rabota-na-zakaz/pedagogika"><a className="none">По педагогике</a></Link>, "3 000"],
                    [<Link href="/kursovaya-rabota-na-zakaz/psihologiya"><a className="none">По психологии</a></Link>, "3 000"],
                    [<Link href="/kursovaya-rabota-na-zakaz/ekonomika"><a className="none">По экономике</a></Link>, "3 500"],
                    [<Link href="/kursovaya-rabota-na-zakaz/yurisprudenciya-pravo"><a className="none">По юриспруденции</a></Link>, "3 000"],
                    [<Link href="/kursovoj-proekt-na-zakaz"><a className="none">Курсовой проект</a></Link>, "5 000"],
                    ["", ""],
                    ["", ""],
                    [<span className="strint">Вот что вам нужно для уверенной защиты:</span>],
                    ["", "Стоимость"],
            ...
            <Accordion
                ...
                rows={[
                    ...
                    ["", "Стоимость"],
                    ["", "от, рублей"],
                    [<Link href="/referat-na-zakaz"><a className="none">Реферат</a></Link>, "1 500"],
                    [<Link href="/zakazat-esse"><a className="none">Эссе</a></Link>,"2 000"],
                    ["Бизнес-план","10 000"],
                    [<Link href="/kontrolnaya-na-zakaz"><a className="none">Контрольная работа</a></Link>,"1 500"],
                    ["Лабороторная работа", "2 500"],
                    ["Решение задач", "500"],
                    ["Тесты и онлайн-тесты", "2 500"],
                    ["Дистанционный экзамен", "3 500"],
                    ["Чертежи", "3 000"],
                    [<Link href="/zakazat-otchet-po-praktike"><a className="none">Отчет по практике</a></Link>, ""],
                    [<Link href="/zakazat-otchet-po-praktike/preddiplomnoj"><a className="none">Преддипломной</a></Link>, "3 500"],
                    [<Link href="/zakazat-otchet-po-praktike/proizvodstvennoj"><a className="none">Производственной</a></Link>, "3 000"],
                    [<Link href="/zakazat-otchet-po-praktike/uchebnoj"><a className="none">Учебной</a></Link>, "3 000"],
                    [<Link href="/zakazat-otchet-po-praktike/pedagogicheskoj"><a className="none">Педагогической</a></Link>, "3 000"],
                    ["", ""],
                    [<span className="strint">Вот что вам нужно для уверенной защиты:</span>],
                    ["", "Стоимость"],
                    ["", "от, рублей"],
