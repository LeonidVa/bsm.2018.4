    ...
    <Wrapper title="Услуги и цены" description="На этой странице представлены цены на дипломные, курсовые работы и многие другие услуги компании.">
        <div className="wrapper bg bg-c2 bg-img bg-img2">
            ...
            <Accordion
                ...
                buttonURL="#form"
                rows={[
                    [<span className="strint">Результатом обучения в высшем учебном заведении является написание дипломной
                                работы. Наша компания выполняет работы по всем дисциплинам для разных учебных заведений.</span>],
                    ["", "от, рублей"],
                    ...
                    ["Слайды", "350 р/шт"],
                    ["Распечатка", "20"],
                    ["Ответы к консультации и защите", "200 р/шт"],
                ]}
            />
            ...
            <Accordion
                ...
                rows={[
                    ...
                    ["Повышение оригинальности", ""],
                    ["", ""],
                    [<span className="strint">Подготовка к консультации и сдаче</span>],
                    ["", ""],
                    ["Консультация с автором"],
