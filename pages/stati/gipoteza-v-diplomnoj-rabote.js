    ...
    <Wrapper title="Главная">
        <div className="wrapper bg bg-c2 bg-img bg-img3">
            ...
            <section className="block-text">
                ...
                <p className="block-text__par">
                    Все эти факторы создают множество сложностей и отнимают много времени, поэтому некоторые предпочитают <Link href="/diplom-na-zakaz"><a>заказать дипломную работу</a></Link> специалистам, нежели затрачивать лишнее время в бессмысленных поисках нужной информации.
                </p>
            </section>
