    ...
    <Wrapper title="Как наладить отношения с научным руководителем? | «BeSmarter!». Тел. +7 (495) 772-40-90.">
        <div className="wrapper bg bg-c2 bg-img bg-img3">
            ...
            <section className="block-text">
                ...
                <p className="block-text__par">
                    В такой ситуации хороший вариант – <Link href="/diplom-na-zakaz"><a>диплом на заказ</a></Link>. Так  Вы решаете проблемы и с научным руководителем, и со своим свободным временем. Однако, не всякая работа может понравиться преподавателю, да и только её текст – далеко не залог отличной оценки. Понадобится несколько составляющих, чтобы навсегда заслужить доверие учителя.
                </p>
            </section>
