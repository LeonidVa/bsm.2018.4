...
const page = () => (
    <Wrapper title="Как составить план дипломной работы образец – пример содержания дипломной работы на сайте компании «BeSmarter!». Тел. +7 (495) 772-40-90.">
        <div className="wrapper bg bg-c2 bg-img bg-img3">
            ...
            <MetaTags>
                {/* <title></title> */}
                <meta name="description" content="В статье раскрыта тема: «Как составить план дипломной работы», приведены общие рекомендации, примеры и образцы заключений дипломных работ." />
            ...
            <section className="block-text">
                ...
                <p className="block-text__par">
                    Поначалу, кажется, что проще <Link href="/diplom-na-zakaz"><b><a>заказать диплом</a></b></Link>, чем его написать, из-за пугающего большого объема. Возможно, для некоторых это действительно выход, но можно собраться с силами и попробовать сделать все самим. Если подойти к составлению плана со всей ответственностью и подробно структурировать каждый пункт, то в голове вырисовывается необходимая работа и все становится гораздо проще.
                </p>
            </section>
