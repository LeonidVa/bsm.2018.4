        ...
        <div className="wrapper bg bg-c2 bg-img bg-img3">
            ...
            <section className="breadcrumbs">
                <div className="inner">
                    ...
                    <span> / </span>
                    <Link href="/skoraya-pomoshch-studentu">
