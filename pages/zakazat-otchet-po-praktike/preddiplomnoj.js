...
const page = () => (
    <Wrapper title="Купить преддипломную практику – заказать отчет по преддипломной практике в Москве | «BeSmarter!». Тел. +7 (495) 772-40-90.">
        <div className="wrapper bg bg-c2 bg-img bg-img4">

            <MetaTags>
                {/* <title></title> */}
                <meta name="description" content="В компании BeSmarter! вы можете заказать отчет по преддипломной практике недорого с печатью в Москве. Тел. +7 (495) 772-40-90." />
            ...
            <section className="block-text">
                ...
                <ul>
                    <li>
                        <b>Качество. </b>Писать вашу работу будут действующие специалисты с кандидатский научной степенью в соответствующей отрасли с соблюдением всех методических требований.
                    </li>
                    <li>
            ...
            <section className="block-text">
                ...
                <ul>
                    <li>
                        Уверенность. Заказав преддипломную практику в нашей компании, вы сможете избежать стрессов, страха перед экзаменом и даже минимальной вероятности провалить защиту.
                    </li>
                    <li>
            ...
            <section className="block-text">
                ...
                <p className="block-text__par">
                    Закажите подробный отчет в нашем офисе по адресу пер. Большой Кисловский, дом 1 стр 2 офис 211.
                </p>
