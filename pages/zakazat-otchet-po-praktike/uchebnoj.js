    ...
    <Wrapper title="Купить отчет по учебной практике – заказать отчет по учебной практике в Москве недорого | «BeSmarter!». Тел. +7 (495) 772-40-90.">
        <div className="wrapper bg bg-c2 bg-img bg-img4">
            ...
            <section className="block-text">
                ...
                <ul>
                    <li>
                        На нашем сайте можно заполнить <a href="#form">онлайн-заявку</a>.
                    </li>
                    <li>
                        Наши менеджеры всегда рады вашему звонку +7(495) 772-4090.
                    </li>
                    <li>
                        Либо встретится лично у нас, в удобном офисе, в центре столицы по адресу, указанному в наших <Link href="/contacts"><a>контактах</a></Link>.
                    </li>
                </ul>
