...
const page = () => (
  <Wrapper title="Диплом по программированию на заказ в Москве и РФ – цены, сроки написания дипломной работы под ключ" description="Диплом по программированию на заказ! Быстро, недорого и профессионально – компания BeSmarter! Звоните: +7 (495) 772-40-90 или +7 (495) 772-90-40.">
...
<MatZashGirl/>
      <TextBlock>
        ...
        <p className="par">
          Если по каким-то причинам вы не успеваете закончить написание диплома по программированию в срок, закажите работу в компании BeSmarter! У нас трудятся авторы, которые являются действующими преподавателями ВУЗов из Москвы и других регионов России.
        </p>
        <p className="par">
      ...
      <TextBlock>
        ...
        <p className="par">
          Выгодно, когда над дипломной работой по программированию трудятся авторы с опытом и пониманием темы. Написание на заказ имеет ряд значительных преимуществ:
        </p>
        <ol>
          <li>
      ...
      <TextBlock>
        ...
        <ul style={{listStyle: 'none'}}>
          ...
          <li>
            - Вы можете написать отдельные главы дипломной работы сами, что автоматически понизит цену.
          </li>
        </ul>
      </TextBlock>
      ...
      <TextBlock>
        ...
        <ol>
          ...
          <li>
            Закажите написание всей дипломной работы по программированию полностью или оформите заказ на отдельные главы, разделы. Мы рекомендуем первый вариант, ведь когда на руках есть полностью готовый диплом, то отвечать на вопросы научного руководителя намного проще.
          </li>
          <li>
