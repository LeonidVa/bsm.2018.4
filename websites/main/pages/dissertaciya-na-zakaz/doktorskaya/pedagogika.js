    ...
    <PageWrapper className="bg bg-c2 bg-img bg-img4">
      ...
      <TextBlock>
        ...
        <p className="par">
          ...
          диссертации – это серьезнейший научный труд, требующий больших умственных и временных затрат. Необходимо изучить, проанализировать и обобщить множество первичных источников, провести социологические и статистические исследования, выработать инновации в области педагогики. Причины, по которым подготовка докторской диссертации может быть затруднена:
        </p>
        <ul>
          <li>
      ...
      <TextBlock>
        ...
        <p className="par">
          Поскольку докторская диссертация является венцом научной деятельности, самой сложной из научных работ, то к ее подготовке привлекаются лучшие специалисты. В некоторых ситуациях их деятельность связана не только с подготовкой самого текста научной работы по педагогике, но и с написанием и публикацией необходимых статей и монографий.
        </p>
        <p className="par">
          При необходимости специалисты нашей компании проведут социологические и иные полевые, статистические исследования. Постоянная обратная связь с соискателем ученой степени в области педагогики служит не только элементом контроля, но залогом качественного написания докторской диссертации. Это дает возможность заказчику своевременно предоставлять
