...
<MatZashGirl/>
      ...
      <TextBlock>
        ...
        <p className="par">
          Однако реалии студенческой жизни таковы, что выкроить время для написания диссертационной работы непросто. Тем более, что требования к ней значительно строже, чем к традиционной дипломной работе или проекту. Решение этой проблемы – написание магистерской диссертации по менеджменту на заказ. Специалисты компании BeSmarter! предлагают
      ...
      <TextBlock>
        ...
        <ul>
          ...
          <li>
            Работа, купленная или скачанная в интернете, не уникальна. Приобретение готового магистерского проекта по менеджменту оправдано лишь в одном случае: если вы работаете над заданием самостоятельно. Тогда такая диссертация может быть использована как основа.
          </li>
        </ul>
      </TextBlock>
      ...
      <TextBlock>
        ...
        <ul>
          ...
          <li>
            Заказ нескольких магистерских диссертаций по менеджменту одновременно. Срабатывает принцип «оптом — дешевле».
          </li>
          <li>
      ...
      <TextBlock>
        ...
        <p className="par">
          Первый этап работы над магистерским проектом по менеджменту – согласование темы и плана написания диссертации. Далее вы оформляете заказ в нашей компании и действуете в таком порядке:
        </p>
        <ul>
          <li>
