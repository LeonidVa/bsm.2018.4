    ...
    <div className="wrapper bg bg-c2 bg-img bg-img3">
      ...
      <section className="breadcrumbs">
        ...
        <span visibility = "hidden" height = "0" weidht = "0" itemScope itemType = "http://schema.org/BreadcrumbList">
            ...
            <span visibility = "hidden" height = "0" width = "0" itemProp = "itemListElement" itemScope
                  itemType = "http://schema.org/ListItem">
                <a visibility = "hidden" height = "0" width = "0" itemProp = "item" href= "https://besmarter.ru/stati/neskolko-pravil-uspeshnoj-zashhity">
                    <span visibility = "hidden" height = "0" width = "0" itemProp = "name">Несколько правил удачной защиты</span></a>
